...
{\color{red}TODO}: discuss parallelization via MPI + TBB within locally owned cells. Also discuss why shared triangulation can't be used and why each MPI core needs to know the whole geometry.
