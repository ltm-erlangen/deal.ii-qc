...
#define SECOND_OF_THREE_IS_SPACEDIM(X)  BOOST_PP_TUPLE_ELEM(3, 1, X)
 ...
 */
#define INSTANTIATE_WITH_SPACEDIM_AND_ATOMICITY(R, CLASS, SPACEDIM_AND_ATOMICITY) \
  BOOST_PP_LIST_FOR_EACH_PRODUCT(CLASS, 2, SPACEDIM_AND_ATOMICITY)
 ...
 */
#define INSTANTIATE_WITH_DIM_SPACEDIM_AND_ATOMICITY(R, CLASS, DIM_SPACEDIM_AND_ATOMICITY) \
  BOOST_PP_LIST_FOR_EACH_PRODUCT(CLASS, 3, DIM_SPACEDIM_AND_ATOMICITY)
