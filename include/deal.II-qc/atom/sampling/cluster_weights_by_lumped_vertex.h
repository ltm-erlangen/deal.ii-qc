...
namespace dealiiqc
{
  ...
  namespace Cluster
  {
     ...
     * weights using lumping procedure based on
     ...
     * \f$\mathscr{L}\f$. If a sampling atom \f$i\f$ is in a cluster \f$I\f$
     ...
     * sampling atoms must be exactly equal to the sum of shape function values
     ...
     */
    template <int dim>
    class WeightsByLumpedVertex : public WeightsByBase <dim>
    {
    public:
       ...
       * and WeightsByLumpedCell class description.
       */
