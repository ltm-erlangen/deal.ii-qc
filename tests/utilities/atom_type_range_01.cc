...
void test ()
{
  ...
  std::cout
      << (int) first_pair.first   << ":" << (int) first_pair.second  << std::endl
      << (int) second_pair.first  << ":" << (int) second_pair.second << std::endl
      << (int) third_pair.first   << ":" << (int) third_pair.second  << std::endl
      << (int) fourth_pair.first  << ":" << (int) fourth_pair.second << std::endl
      << (int) sixth_pair.first   << ":" << (int) sixth_pair.second  << std::endl;
}
