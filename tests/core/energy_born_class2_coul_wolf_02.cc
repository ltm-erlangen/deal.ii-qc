...
cmds = [
    "units metal",
    "atom_style full",
    "read_data BaTiO3_cs_1x1x1_atom.data",
...
sum_q2 = np.inner(barium_titanate_cs_charges,barium_titanate_cs_charges)
print("Self Energy", 0.3577238031364605*14.399645*sum_q2)
