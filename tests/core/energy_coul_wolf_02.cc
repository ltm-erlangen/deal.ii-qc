...
//  The processes own different active cells. The cluster radius and the energy
//  radius are such that both the process have 2 energy
//  atoms, however only one process should contain a non-zero sized
//  neighbor_lists data member (by the virtue of get_neighbor_lists()
//  algorithm).
