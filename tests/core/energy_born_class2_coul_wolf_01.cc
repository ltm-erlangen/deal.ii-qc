  ...
  try
    {
      ...
      oss
        ...
        << "  set Pair global coefficients = 0.25, 2.5, 2.5" << std::endl
        ...
        << "3 2 1  0.0 1.00 0. 0." << std::endl
        << "4 2 2  0.0 1.25 0. 0." << std::endl
        << std::endl
        << "Bonds #" << std::endl
        << "1 1 1 2" << std::endl
        << "2 1 3 4" << std::endl;
      ...
      // Define Problem
      Problem<dim, Potential::PairBornCutClass2CoulWolfManager, 2> problem(
        config);
      problem.partial_run(-0.648907174652545 /*blessed energy from LAMMPS*/);
    }
...
cmds = ["units metal",
        "atom_style full",
        "read_data test.data",
        "pair_style born/coul/wolf 0.25 2.5 2.5",
        "pair_coeff * * 0.877 1. 1.55 0.877 0"
        "bond_style class2",
