...
namespace Potential
{
  ...
  PairLJCutCoulWolfManager::PairLJCutCoulWolfManager (const double &alpha,
  ...
  void
  PairLJCutCoulWolfManager::set_charges (std::shared_ptr<std::vector<types::charge>> &charges_)
  {
  ...
  void
  PairLJCutCoulWolfManager::declare_interactions (const types::atom_type i_atom_type,
